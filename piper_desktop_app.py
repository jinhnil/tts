...
class MultiEngineDesktopReader:
    ...
    def setup_ui(self):
        ...
        subtitle = tk.Label(
            title_box,
            text="Ứng dụng đọc truyện Tiếng Việt đa giọng đọc & xử lý Offline",
            font=("Segoe UI", 9),
            bg="#0d1527",
            fg=self.fg_muted
        )
        ...
        # Main Reader Text Display Container
        ...
        player_bar.pack(fill=tk.X, padx=10, pady=(2, 8))
